...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        if (! $this->validate($rules)) {
            ...
            // Add validation rule for image
        $rules['image'] = 'uploaded[image]|mime_in[image,image/png,image/jpeg,image/gif]|max_size[image,1024]';
        ...
        if ($profileImage->isValid() && !$profileImage->hasMoved()) {
            ...
            // Simpan nama file atau path ke database sesuai kebutuhan aplikasi Anda
            $user->image = $newName; // Simpan nama gambar ke dalam kolom 'image'
        }
